...
6. Deploy [`cloud`](https://github.com/zeelos/zeelos/blob/master/cloud.dockerapp/docker-compose.yml) stack: 
	...
	On the cloud node, verify that cloud services have all been started correctly:
		...
		c58406cb80ce        zeelos/influxdb:1.6.2-with-zeelosdb                 "/entrypoint.sh infl…"   8 hours ago          Up 8 hours              8086/tcp                       cloud_influxdb.1.9o0v5fzvnzfcnp717inhq6cym
		65b658bb5b35        zeelos/orientdb:3.0.7-tp3-with-zeelosdb             "server.sh"              8 hours ago          Up 8 hours              2424/tcp, 2480/tcp             cloud_orientdb.1.yf07hk6c4lbjzq0o7slp2r9hw
